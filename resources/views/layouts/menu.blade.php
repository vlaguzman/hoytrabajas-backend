...
<li class="{{ Request::is('sectors*') ? 'active' : '' }}">
    <a href="{!! route('sectors.index') !!}"><i class="fa fa-edit"></i><span>Sectors</span></a>
</li>
...
<li class="{{ Request::is('empleadors*') ? 'active' : '' }}">
    <a href="{!! route('empleadors.index') !!}"><i class="fa fa-edit"></i><span>Empleadors</span></a>
</li>
...
<li class="{{ Request::is('sectorCandidatos*') ? 'active' : '' }}">
    <a href="{!! route('sectorCandidatos.index') !!}"><i class="fa fa-edit"></i><span>SectorCandidatos</span></a>
</li>

<li class="{{ Request::is('estudiosCandidatos*') ? 'active' : '' }}">
    <a href="{!! route('estudiosCandidatos.index') !!}"><i class="fa fa-edit"></i><span>EstudiosCandidatos</span></a>
</li>

<li class="{{ Request::is('idiomasCandidatos*') ? 'active' : '' }}">
    <a href="{!! route('idiomasCandidatos.index') !!}"><i class="fa fa-edit"></i><span>IdiomasCandidatos</span></a>
</li>
...
<li class="{{ Request::is('membresiaPrecios*') ? 'active' : '' }}">
    <a href="{!! route('membresiaPrecios.index') !!}"><i class="fa fa-edit"></i><span>MembresiaPrecios</span></a>
</li>

<li class="{{ Request::is('membresiaCandidatos*') ? 'active' : '' }}">
    <a href="{!! route('membresiaCandidatos.index') !!}"><i class="fa fa-edit"></i><span>MembresiaCandidatos</span></a>
</li>

<li class="{{ Request::is('membresiaEmpleadors*') ? 'active' : '' }}">
    <a href="{!! route('membresiaEmpleadors.index') !!}"><i class="fa fa-edit"></i><span>MembresiaEmpleadors</span></a>
</li>
...
<li class="{{ Request::is('membresias*') ? 'active' : '' }}">
    <a href="{!! route('membresias.index') !!}"><i class="fa fa-edit"></i><span>Membresias</span></a>
</li>
